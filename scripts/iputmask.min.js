                      ...
                      try {
                        if ('input' === l)
                          (d.inputType = 'insertText'),
                            (f = new InputEvent(l, d))
                        else f = new CustomEvent(l, d)
                      } catch (e) {
                        ;(f = document.createEvent(
                          'CustomEvent',
                        )).initCustomEvent(l, d.bubbles, d.cancelable, d.detail)
                      }
          ...
          var f = {
            keydownEvent: function (e, t, i, c, u) {
              ...
              if (
                ...
                e.preventDefault(),
                  o.handleRemove.call(p, m, k, y),
                  (0, s.writeBuffer)(
                    m,
                    a.getBuffer.call(p, !0),
                    v.p,
                    e,
                    m.inputmask._valueGet() !== a.getBuffer.call(p).join(''),
                  )
                ...
                (k === n.keys.Home && !e.shiftKey) || k === n.keys.PageUp
                  ? (e.preventDefault(),
                    a.caret.call(p, m, 0, e.shiftKey ? y.begin : 0, !0))
                  : d.undoOnEscape && k === n.keys.Escape && !0 !== e.altKey
                  ? ((0, s.checkVal)(m, !0, !1, p.undoValue.split('')),
                    g.trigger('click'))
                  : k !== n.keys.Insert ||
                    e.shiftKey ||
                    e.ctrlKey ||
                    void 0 !== p.userOptions.insertMode
                  ? !0 === d.tabThrough && k === n.keys.Tab
                    ? !0 === e.shiftKey
                      ? ((y.end = a.seekPrevious.call(p, y.end, !0)),
                        !0 === l.getTest.call(p, y.end - 1).match.static &&
                          y.end--,
                        (y.begin = a.seekPrevious.call(p, y.end, !0)),
                        y.begin >= 0 &&
                          y.end > 0 &&
                          (e.preventDefault(),
                          a.caret.call(p, m, y.begin, y.end)))
                      : ((y.begin = a.seekNext.call(p, y.begin, !0)),
                        (y.end = a.seekNext.call(p, y.begin, !0)),
                          ...
                          : k === n.keys.Left &&
                            setTimeout(function () {
                              ...
                              p.isRTL
                                ...
                                : a.caret.call(p, m, e - (0 === e ? 0 : 1))
                            }, 0)))
                  : o.isSelection.call(p, y)
                  ? (d.insertMode = !d.insertMode)
                  : ((d.insertMode = !d.insertMode),
                    a.caret.call(p, m, y.begin, y.begin))
              return (
                (p.ignorable = d.ignorables.includes(k)),
            ...
            keypressEvent: function (e, t, i, r, l) {
              ...
              if (v) {
                var m,
                  g = t ? { begin: l, end: l } : a.caret.call(c, d)
            ...
            keyupEvent: function (e) {
              ...
              t.isComposing &&
                ((e.keyCode !== n.keyCode.KEY_229 && e.key !== n.keys.Enter) ||
                  t.$el.trigger('input'))
            },
            ...
            inputFallBackEvent: function (e) {
              ...
              if (p !== u) {
                ...
                switch (
                  ...
                  a.caret.call(t, c, d.begin, d.end, !0),
                  h.action)
                ) {
                  case 'insertText':
                  case 'insertReplacementText':
          ...
          a.default.extendAliases({
            datetime: {
                        ...
                        for (
                          ...
                          if ((o = x(r)) && o[3]) {
                            for (
                              ...
                              void 0 !== a.validPositions[d + r.index] || p
                                ? ((f[d] = l[d]), (p = p || l[d] > c[d]))
                                : ((f[d] = c[d]),
                                  'year' === o[2] &&
                                    l.length - 1 == d &&
              ...
              onKeyDown: function (e, t, i, a) {
                e.ctrlKey &&
                  e.key === n.keys.Right &&
                  (this.inputmask._valueSet(E(new Date(), a)),
                ...
                if (d) y()
                  ...
                  switch (o.charAt(0)) {
                    ...
                    case i.quantifiermarker[0]:
                      ...
                      ;('*' !== E && '+' !== E) || (E = '*' === O ? 0 : 1),
                        (S.quantifier = { min: E, max: O, jit: T })
                    ...
                    case i.alternatormarker:
                      if (v.length > 0) {
                        var B = (l = v[v.length - 1]).matches[
                          l.matches.length - 1
                        ]
                        u =
                          l.openGroup &&
                          (void 0 === B.matches ||
                            (!1 === B.isGroup && !1 === B.isAlternator))
                            ? v.pop()
                            : P(l.matches)
                      } else u = P(h.matches)
              ...
              if (e.begin === e.end) {
                switch ((i = i || u.positionCaretOnClick)) {
                  ...
                  default:
                    ...
                    if (p <= h)
                      e.end = e.begin = s.call(n, p, !1, !0) ? p : l.call(n, p)
                    else {
                  ...
                  if (r.isGroup && c !== r) {
                    ...
                    if (-1 === D || 'string' == typeof D) {
                      ...
                      if ('string' == typeof D) C = D.split(',')
                        ...
                        for (j = 0; j < _.matches.length; j++)
                          C.push(j.toString())
                      if (void 0 !== l.excludes[e]) {
                        for (
                          var R = C.slice(), L = 0, F = l.excludes[e].length;
                          L < F;
                          L++
                        ) {
                      ...
                      for (var V = 0; V < C.length; V++) {
                        ;(j = parseInt(C[V])),
                          (m = []),
                          (i =
                            ('string' == typeof D && v(h, j, O)) || B.slice())
                        var N = _.matches[j]
                          ...
                          for (var K = 0; K < M.length; K++) {
                            ...
                            if (
                              ...
                              (void 0 !== H.alternation &&
                                C.includes(H.locator[H.alternation].toString()))
                            ) {
                              ...
                              if (
                                ...
                                !0 === (Y = H).match.static &&
                                  !0 !== Z.match.static &&
                                  Z.match.fn.test(Y.match.def, l, e, !1, u, !1))
                              ) {
                                x(H, $) ||
        ...
        7215: function (e, t, i) {
          Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.handleRemove = function (e, t, i, o, l) {
              ...
              if (!1 !== (d = v.call(c, i))) {
                ...
                !0 !== o &&
                  ((u.p = t === n.keys.Delete ? i.begin + d : i.begin),
          ...
          function s(e, t, i, n, o, l) {
            ...
            if (
              ...
              (c = 0), (u = (d = a.getTest.call(x, c)).alternation)
            else
              for (; T >= 0; T--)
            ...
            if (void 0 !== u) {
              ...
              for (
                ...
                for (
                  ...
                  h < D.length &&
                  ((g =
                    E.caret || r.getLastValidPosition.call(x, void 0, !0) + 1),
                  (k = D[h]),
                  (E = f.call(x, g, k, !1, n, !0)));
                  h++
                )
                  h === j && (O = E), 1 == e && E && (O = { caretPos: h })
                if (E) break
                if (
                  (r.resetMaskSet.call(x),
                  (d = a.getTest.call(x, m)),
          ...
          function f(e, t, i, n, o, p, m) {
                  ...
                  if (
                    ...
                    !1 !==
                      (s =
                        ...
                        (null != p.fn
                          ? p.fn.test(i, b, t, o, y, u.call(g, e))
                          : (i === p.def ||
                    ...
                    return (
                      (d =
                        d === y.skipOptionalPartCharacter && !0 === p.static
                      ...
                      !0 !== s && void 0 === s.pos && void 0 === s.c
                        ...
                        : (!1 ===
                            v.call(
                              g,
                              e,
                              k.extend({}, c, { input: l.call(g, d, p, h) }),
                              n,
                              h,
                            ) && (s = !1),
                          !1)
            ...
            if (
              ...
              if (
                ((S = w(x, t, i)), (!i || !0 === n) && !1 === S && !0 !== p)
              ) {
                var E = b.validPositions[x]
                if (
                  !E ||
                  !0 !== E.match.static ||
                  (E.match.def !== t && t !== y.skipOptionalPartCharacter)
                ) {
                  if (
                    y.insertMode ||
                    ...
                    if (
                      ...
                      !O && !r.isMask.call(g, x, y.keepStatic && 0 === x))
                    )
                      for (
                        ...
                        if (!1 !== (S = w(T, t, i))) {
                          ;(S =
                            h.call(g, x, void 0 !== S.pos ? S.pos : T) || S),
                            (x = T)
                          break
                        }
                  }
              ...
              if (void 0 === o.validPositions[l] && !r.isMask.call(n, l, !1))
                if (0 == l ? a.getTest.call(n, l) : o.validPositions[l - 1]) {
                  ...
                  if (
                    ...
                    (((p = s.extend({}, p, {
                      input:
                        a.getPlaceholder.call(n, l, p.match, !0) || p.match.def,
                    })).generatedInput = !0),
                    v.call(n, l, p, !0),
                    !0 !== i)
                  ) {
                    ...
                    return (
                      (o.validPositions[t] = void 0), f.call(n, t, d, !0, !0)
                    )
                  }
                }
            }
