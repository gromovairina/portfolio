!(function (e, t) {
  ...
  return (function () {
    ...
    class _ {
      constructor() {
        let { type: e, date: t, dp: i, opts: s, body: a } =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
        C(this, 'focus', () => {
        ...
        M(this, 'handleClick', (e) => {
          ...
          M(this, 'onClickBody', (e) => {
            let { onClickDayName: t } = this.opts,
              i = e.target
            i.closest('.air-datepicker-cell') && this.handleClick(e),
              t &&
    ...
    class K {
        ...
        if (
          ...
          N(this, 'update', (e) => {
            ...
            this._createMinMaxDates(),
              ...
              !t.isMobile && h
                ? (this.treatAsInline || P || this._createMobileOverlay(),
      ...
      init() {
        ...
        B ||
          ...
          !this.elIsInput ||
          ((B = !0),
          (R = n({ className: (o = K.defaultContainerId), id: o })),
          I.appendChild(R)),
      ...
      _addButtons() {
        ;(this.$buttons = n({ className: 'air-datepicker--buttons' })),
          ...
          (this.buttons = new x({ dp: this, opts: this.opts })),
